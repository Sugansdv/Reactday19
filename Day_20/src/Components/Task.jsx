...
function Task1() {
  return (
    <div className=' w-75 m-auto mt-5'>
      <h2>Task 1.Introduction to React Portals</h2>
      <p>
        <strong>What are React Portals?</strong><br />
      ...
      <p>
        <strong>Why are React Portals used?</strong><br />
        Portals are useful for rendering components like modals, tooltips, and dropdowns that visually break out of their parent container without breaking the React component tree.
      </p>
    </div>
  );
}
      ...
      <div className="card-header bg-primary text-white">
        ...
        <PortalWrapper>
          <div className="alert alert-info border position-fixed top-0 left-0 w-50 m-auto mt-2">
           Task2. This content is rendered outside the main DOM tree using a <strong>React Portal</strong>.
          </div>
        </PortalWrapper>
    </div>
  </div>
